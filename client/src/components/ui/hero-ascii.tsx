...
// Add global type definition for Unicorn Studio
declare global {
    interface Window {
        UnicornStudio: {
...
export default function HeroAscii() {
    ...
    `;
        ...
        // CSS injection for branding hiding alongside the component
    ...
    `;
        ...
        // Aggressive hiding schedule
        hideBranding();
        const interval = setInterval(hideBranding, 100);
        const timeouts = [1000, 3000, 5000].map(delay => setTimeout(hideBranding, delay));
    ...
    return (
        <main className="relative min-h-screen overflow-hidden bg-black font-sans text-white">
            ...
            {/* Top Header */}
            <div className="absolute top-0 left-0 right-0 z-20 border-b border-white/20 backdrop-blur-[2px]">
                ...
                <div className="container mx-auto px-6 lg:px-16 lg:ml-[10%]">
                    <div className="max-w-lg relative">
                        ...
                        <div className="relative">
                            ...
                            <h1 className="text-4xl lg:text-7xl font-bold text-white mb-3 lg:mb-4 leading-[0.9] font-mono tracking-wider uppercase">
                                PERFECT
                                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-white to-white/50 mt-1 lg:mt-2">
                                    PROPORTIONS
                                </span>
                            </h1>
                        </div>
                        ...
                        <div className="relative">
                            <p className="text-xs lg:text-base text-gray-300 mb-5 lg:mb-6 leading-relaxed font-mono opacity-80 uppercase tracking-wide">
                                Where geometry meets humanity — Da Vinci's vision of ideal form remastered for the digital age.
                            </p>
                        ...
                        <div className="flex flex-col lg:flex-row gap-3 lg:gap-4">
                            <Link href="/editor">
                                <button className="w-full lg:w-auto relative px-8 py-3 bg-white text-black font-mono text-xs lg:text-sm border border-white hover:bg-transparent hover:text-white transition-all duration-300 group tracking-widest font-bold">
                            ...
                            <button className="w-full lg:w-auto relative px-8 py-3 bg-transparent border border-white text-white font-mono text-xs lg:text-sm hover:bg-white/10 transition-all duration-300 tracking-widest uppercase">
                                Documentation
                            </button>
                        </div>
                        ...
                        <div className="hidden lg:flex items-center gap-2 mt-6 opacity-40">
                            ...
                            <div className="flex-1 h-px bg-white"></div>
                            <span className="text-white text-[9px] font-mono">VITRUVIAN_Protocol_v9</span>
                        </div>
                    </div>
                </div>
            </div>
